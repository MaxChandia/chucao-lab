...
const Navbar = () => {
    return (
        <nav className="absolute z-50 h-[90px] w-full flex items-center justify-between px-20 bg-transparent border-b border-gray-100 text-white shadow-lg font-jetbrains">
            <Link href="/"><Image src={logoImage} alt="ChucaoLab" className='h-[70px] w-[90px]' /></Link>
            ...
            <div className="socialMedia flex gap-4">
                ...
                <a className="socialMediaLink h-10 w-10 rounded-full p-2 bg-black hover:bg-gray-700" href="https://www.instagram.com/chucao.lab/" target="_blank" rel="noopener noreferrer">
                    <FontAwesomeIcon icon={faInstagram} className='h-full w-full' />
                </a>
                <a className="socialMediaLink h-10 w-10 rounded-full p-2 bg-black hover:bg-gray-700" href="https://www.youtube.com/@chucao_lab" target="_blank" rel="noopener noreferrer">
