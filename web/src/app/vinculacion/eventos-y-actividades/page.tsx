...
export default async function Novedades({ searchParams }: PageProps) {
    const allNoticias: Noticia[] = (await sanityService.getAllNoticias()) || [];

    // 1. Filtramos solo las noticias que tienen la categoría "Novedad"
    const novedades = allNoticias.filter(noticia => noticia.categoria === "Eventos");
    ...
    const currentNovedades = novedades.slice(startIndex, startIndex + itemsPerPage);
    ...
    return (
        <div className="bg-[#eefbfc] min-h-screen">
            ...
            <section className="py-20 px-8 md:px-16 lg:px-24 w-full mb-20">
                                ...
                                >
                                    <div className="flex flex-col h-full transition-all duration-300 transform group-hover:-translate-y-1">
                                        ...
                                        <div className="mt-5 flex flex-col flex-1">
                                            {/* Altura mínima min-h-[4.5rem] para forzar las 3 líneas */}
                                            <div className="flex gap-3 items-start mb-2 min-h-[3rem]">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="shrink-0 mt-0.5 text-sage-green" viewBox="0 0 16 16">
                                                    <path fillRule="evenodd" d="M8.5 2a.5.5 0 0 1 .5.5v11a.5.5 0 0 1-1 0v-11a.5.5 0 0 1 .5-.5m-2 2a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5m4 0a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5m-6 1.5A.5.5 0 0 1 5 6v4a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m8 0a.5.5 0 0 1 .5.5v4a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5m-10 1A.5.5 0 0 1 3 7v2a.5.5 0 0 1-1 0V7a.5.5 0 0 1 .5-.5m12 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0V7a.5.5 0 0 1 .5-.5"/>
                                                </svg>
                                                <h3 className="font-bold font-jetbrains text-left text-[15px] leading-snug text-black group-hover:text-sage-green transition-colors line-clamp-3">
                                                    {noticia.titulo}
                                                </h3>
                                            </div>
